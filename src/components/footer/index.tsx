    ...
    <footer className="bg-gray-900 text-white px-32 py-16 font-open_sans">
      ...
      <img src="/images/logo2.png" alt="Logo" className="h-14 " />
        ...
        <div className='col-span-3'>
          <p className='text-base mb-3 text-gray-500'>ĐỊA CHỈ</p>
        ...
        <div className='col-span-3'>
          <h2 className="text-base mb-3 text-gray-500">LIÊN HỆ</h2>
        ...
        <div className='col-span-3'>
          <h2 className="text-base mb-3 text-gray-500">THEO DÕI CHÚNG TÔI</h2>
