...
const CardComponent: React.FC<CardComponentProps> = ({ slideId }) => {
  return (
        ...
        <CarouselItem className="md:basis-1/2 lg:basis-1/4">
          <Link href={`/detailslide/${slideId}`}>
            <div className="relative flex flex-col rounded-xl bg-white text-gray-700 shadow-lg">
              ...
              <div className="p-6">
                <h5 className="font-medium text-xl text-center text-blue-gray-900">Bài giảng Family and Friends 2</h5>
